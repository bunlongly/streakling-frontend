...
export default function PublicCardItem({ card, onDelete }: Props) {
  const bannerUrl = buildPublicUrl((card as any).bannerKey);
  const avatarUrl = buildPublicUrl((card as any).avatarKey);
    ...
    <div className="rounded-xl border overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-4 relative">
        ...
        <div className="mt-4 flex gap-2">
          {/* Public view page (adjust to your route) */}
          <Link
